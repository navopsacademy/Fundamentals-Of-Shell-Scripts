...
4. List some of the common and most widely used UNIX commands. 5. Shell programs are stored in which file?
...
29.What are the three different security provisions provided by UNIX for a
file or data
...
34.What are control instructions and how many types of control instructions
are available in a shell? Explain in brief
...
41.Which command needs to be used to know how long the system has been
running
42.How to find the current shell which you are usin
43.How to find all the available shells in your system
44.How to read keyboard inputs in shell scripts
45.How many fields are present in a crontab file and what does each field
specify?
...
50.How to find out the total disk space used by a specific user, say for
example username is John
51.What is Shebang in a shell script?
52.What is the command to be used to display the shell’s environment
variables
...
57.How can the contents of a file inside jar be read without extracting in a
shell script?
